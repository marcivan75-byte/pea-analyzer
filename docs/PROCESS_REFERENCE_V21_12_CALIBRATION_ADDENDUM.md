# Addendum au process de référence — V21.12 Calibration
...
À compter de V21.12, toute **nouvelle calibration ordinaire** de paramètres doit respecter `config/CALIBRATION_WINDOWS_V21_12.json` et `src/v182/backtest/calibration_windows.py`.
...
9. Les historiques et preuves legacy restent conservés pour traçabilité ; ils ne deviennent pas automatiquement des données de recalibration V21.12.
...
Le document détaillé est `docs/CALIBRATION_WINDOWS_V21_12.md`.
