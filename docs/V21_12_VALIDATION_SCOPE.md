# V21.12 — Scope de validation gelé avant résultats
...
Les tests V21.12 doivent démontrer la séparation des ensembles et le rejet fail-closed des lignes stress/futures dans la calibration principale.
