...
from v182.reporting import daily_ci_light_v21_8_4 as ci_light
...
def run(root: Path = ROOT) -> dict:
    ...
    steps["source_reliability_v21_8_4"] = source_patch
    steps["ci_light_v21_8_4"] = {
        "status": ci_status,
        **ci_payload,
