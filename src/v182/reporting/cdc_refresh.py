    ...
    payload = {
        ...
        **counts,
        ...
        "governance": {
            ...
            "amf_publication_start_required": True,
            "amf_publication_end_required": True,
            "amf_latest_active_record_per_holder": True,
            "amf_observation_as_of_policy": "LATEST_RETAINED_PUBLIC_DISCLOSURE_DATE",
            "amf_freshness_age_field": "amf_public_short_days_since_latest_publication",
