...
def run(root: Path, actions_path: Path, etf_path: Path) -> dict:
    ...
    adetail,asummary=weighted_coverage(actions,action_registry,("CT","MT","SHORT","TOP_DOWN"),"ACTION")
    edetail,esummary=weighted_coverage(etf,etf_registry,("CT","SHORT","TOP_DOWN","MT_BASELINE_V20_7"),"ETF")
