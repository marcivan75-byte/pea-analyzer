...
def apply_governance(decisions: pd.DataFrame, cfg: dict) -> pd.DataFrame:
    ...
    out["v21_8_decision_influence"] = 0.0
    out["v21_8_score_influence"] = 0.0
    out["v21_8_sizing_influence"] = 0.0
...
def run(root: Path = ROOT) -> dict:
    ...
    payload = {
        ...
        "desired_loss_risk_ceiling_pct_for_research": cfg["risk"]["desired_loss_risk_ceiling_pct_for_research"],
        "desired_loss_risk_ceiling_is_blind_stop": False,
