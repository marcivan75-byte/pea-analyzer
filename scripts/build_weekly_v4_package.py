...
def _readme(summary: dict) -> str:
    ...
    return (
        ...
        "journalier, hebdomadaire et mensuel avec preuve d'identité stricte. Boursorama reste un contrôle de qualité "
        "Actions; les ETF utilisent Morningstar et n'exigent pas de consensus analystes.\n\n"
...
def build(root: Path, package_dir: Path, *, release_commit: str) -> dict:
    ...
    included = SOURCE_FILES + [relative for relative in EVIDENCE_FILES if (root / relative).exists()]
