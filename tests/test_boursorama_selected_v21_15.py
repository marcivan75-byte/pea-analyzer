...
ouverture 167,220 clôture veille 167,380 + haut 168,040 + bas 166,080
...
<tr><td>Dividende par action</td><td>3,36 EUR</td><td>3,60 EUR</td><td>3,90 EUR</td></tr>
<tr><td>Rendement</td><td>1,95%</td><td>2,09%</td><td>2,27%</td></tr>
<tr><td>Bénéfice net par action</td><td>5,80 EUR</td><td>6,34 EUR</td><td>7,15 EUR</td></tr>
...
def test_selected_boursorama_uses_short_and_deep_ttl_and_never_persists_html(tmp_path: Path):
    calls = []
    ...
    first = collect_selected_action_context_cached(
        rows,
        cache,
