# PEA Analyzer — Package ETF V21.18.1R4
...
- `KNOWN_DEBT.md` : plan versionné de récupération et re-preuve des 46 critères reconstruits.
- `examples/` : exemples validés pour chaque contrat JSON Schema.
...
Le mode `--strict` échoue volontairement tant que la source canonique `03_ETF_268` reste indisponible : `python tools/validate_package.py --strict`.
